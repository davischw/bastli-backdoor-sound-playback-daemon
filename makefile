...
all: main.o soundserver_parent_main.o rmq_interface.o play_sound.o
	gcc -lSDL_mixer -lSDL -lrabbitmq -ljson-c -o sound_test soundserver_parent_main.o rmq_interface.o play_sound.o
